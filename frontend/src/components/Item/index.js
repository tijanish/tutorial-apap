...
export default function Item(props) {
    ...
    return(
    <div
        className="list-group-item 1ist-group-item-action d-flex align-items-center justify-content-between flex-row w-18@ mb-3">
        <div className="d-flex">
            ...
            <div>
                ...
                <p className="font-weight-bold mb-8 text-md">Harga: Rp {price} k</p>
